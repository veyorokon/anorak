...
confServer ()
{
    ...
    find ./  -name '*.jsx' -type f -exec sed -i '' -e 's/pk_test_rLuroFoR4XKOxb3FbmJqTqrh/pk_live_8tYimrx0lEM0zJ2tVyQwwyZM/g' {} +
}  
...
confLocal ()
{
    ...
    find ./  -name '*.jsx' -type f -exec sed -i '' -e 's/pk_live_8tYimrx0lEM0zJ2tVyQwwyZM/pk_test_rLuroFoR4XKOxb3FbmJqTqrh/g' {} +
