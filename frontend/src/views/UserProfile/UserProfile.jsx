        ...
        <GridItem xs={24} sm={24} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>Add Subscription</h4>
              <p className={classes.cardCategoryWhite}>Connect your existing subscription account or create one.</p>
            </CardHeader>
            <CardBody>
              <GridContainer>
